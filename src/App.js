      ...
      <section id="about" className="section about">
        <div className="container about-row">
          <div className="about-text-container">
            ...
            <p className="about-text">Friends of Carleton Rugby is a mobile app development studio focused on building innovative, high-quality, and user-friendly applications. Our official website showcases the full range of apps developed by Solvertech Africa Mobile – from casual games and productivity tools to educational and lifestyle applications.
            </p>
          </div>
